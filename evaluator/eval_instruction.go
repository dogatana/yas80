...
var evalZ80InstructionFuncs = map[int]evalZ80InstructionFunc{
	...
	parser.Z80_INST_SUB:  (*Evaluator).evalZ80_AND,
	parser.Z80_INST_AND:  (*Evaluator).evalZ80_AND,
	parser.Z80_INST_OR:   (*Evaluator).evalZ80_AND,
	parser.Z80_INST_XOR:  (*Evaluator).evalZ80_AND,
	parser.Z80_INST_CP:   (*Evaluator).evalZ80_AND,
