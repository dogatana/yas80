...
func (e *Evaluator) evalZ80_ADD16(stmt *parser.Z80Instruction, op1, op2 object.Object, env TEnv) object.Object {
	...
	case parser.Z80_INST_ADD:
		code = &object.CodeObject{Code: []byte{0x09}, TStates: [2]byte{11, 1}, Context: stmt.Context}
	case parser.Z80_INST_ADC:
		code = &object.CodeObject{Code: []byte{0xed, 0x4a}, TStates: [2]byte{15, 2}, Context: stmt.Context}
